...
using System.Text;
using SqliteManagerWcfService.Model;

namespace SqliteManagerWcfService
{
    // 注意: 使用“重构”菜单上的“重命名”命令，可以同时更改代码和配置文件中的类名“Service1”。
    public class SqliteManagerWcfS : ISqliteManagerWcfS
    {
        #region 成员变量
        // 未发布的程序不能使用相对路径
        //static readonly string strCon = "./data.db"; //; Password=1111  // sqlite数据库连接字符串
